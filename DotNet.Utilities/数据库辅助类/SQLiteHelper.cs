    ...
    public class SQLiteHelper
    {
        ...
        {//"Data Source=Test.db3;Pooling=true;FailIfMissing=false";  
            get
            {
                ...
                string text = "Data Source=" + AppDomain.CurrentDomain.BaseDirectory + "pedata.db3;Pooling =true;FailIfMissing = false";// ConfigurationManager.AppSettings["SQLiteConnectionString"];
